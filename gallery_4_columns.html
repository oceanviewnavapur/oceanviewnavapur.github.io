...
<body>
    ...
    <div class="container margin_60">
        ...
        <div class="row magnific-gallery add_bottom_60 ">
            ...
            <div class="col-md-3 col-sm-3">
                <a href="img/pic_7.jpg" title="Photo title"><img src="img/pic_7.jpg" alt="" class="img-responsive styled"></a>
            </div>
            <div class="col-md-3 col-sm-3">
                <a href="img/pic_8.jpg" title="Photo title"><img src="img/pic_8.jpg" alt="" class="img-responsive styled"></a>
            </div>
        </div><!-- End row -->
        ...
        <div class="row magnific">
            ...
            <div class="col-md-3 col-sm-3">
                <a href="https://www.youtube.com/watch?v=Zz5cu72Gv5Y" class="video" title="Video Youtube"><img src="img/pic_4.jpg" alt="" class="img-responsive styled"></a>
            </div>
        </div><!-- End row -->
    </div><!-- End container -->
